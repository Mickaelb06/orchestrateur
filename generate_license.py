...
Usage : python3 generate_license.py --email client@example.com --tier pro --days 365
...
def generate_license(email: str, tier: str, days: int) -> str:
    ...
    payload = json.dumps({"email": email, "tier": tier, "exp": exp}, separators=(",", ":")).encode()
...
if __name__ == "__main__":
    ...
    key = generate_license(args.email, args.tier, args.days)
